...
type JoinReq = {
    ...
    static member UpdatePeer ((* JoinReq *) update : Peer -> Peer) (this : JoinReq) =
        this |> JoinReq.SetPeer (update this.Peer)
    static member UpdatePassHash ((* JoinReq *) update : string -> string) (this : JoinReq) =
        this |> JoinReq.SetPassHash (update this.PassHash)
